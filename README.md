# [Flask Dashboard](https://appseed.us/admin-dashboards/flask) Material Admin
...
Material Admin is free admin template that is entirely built using the framework Google’s Material Design for the Web to comply with the Material Design guidelines. It comes with the basic components and set of pre-built pages required to lay the foundation for any application.
...
---
[Flask Dashboard](https://appseed.us/admin-dashboards/flask) Material Admin - Provided by **AppSeed [App Generator](https://appseed.us/app-generator)**.
